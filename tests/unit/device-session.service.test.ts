...
describe('DeviceService', () => {
  ...
  describe('registerDevice', () => {
    ...
    it('should validate device type', async () => {
      ...
      // Act & Assert
      await expect(deviceService.registerDevice(
        'tenant-123',
        'user-123',
        invalidDeviceData
  ...
  describe('trustDevice', () => {
    ...
    it('should throw NotFoundError for non-existent device', async () => {
      ...
      // Act & Assert
      await expect(deviceService.trustDevice(
        'tenant-123',
        'user-123',
        'non-existent'
      )).rejects.toThrow(NotFoundError)
...
describe('SessionService', () => {
  ...
  describe('createSession', () => {
    it('should successfully create session', async () => {
      ...
      // Act
      const result = await sessionService.createSession('tenant-123', sessionData)
  ...
  describe('getSession', () => {
    ...
    it('should throw NotFoundError for non-existent session', async () => {
      ...
      // Act & Assert
      await expect(sessionService.getSession(
        'tenant-123',
        'user-123',
        'non-existent'
      )).rejects.toThrow(NotFoundError)
  ...
  describe('updateSessionActivity', () => {
    ...
    it('should throw NotFoundError for non-existent session', async () => {
      ...
      // Act & Assert
      await expect(sessionService.updateSessionActivity(
        'tenant-123',
        'non-existent',
        { lastActiveAt: new Date() }
      )).rejects.toThrow(NotFoundError)
  ...
  describe('revokeSession', () => {
    ...
    it('should throw NotFoundError for non-existent session', async () => {
      ...
      // Act & Assert
      await expect(sessionService.revokeSession(
        'tenant-123',
        'user-123',
        'non-existent'
      )).rejects.toThrow(NotFoundError)
  ...
  describe('revokeAllSessions', () => {
    ...
    it('should exclude current session when requested', async () => {
      ...
      const sessionsToRevoke = [
        { ...mockSession, id: 'other-session-456' },
      ]
