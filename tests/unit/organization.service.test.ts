...
import { mockDbOperations, mockEvents, mockUser, mockOrganization } from '../helpers/test-utils'
...
describe('OrganizationService', () => {
  ...
  describe('createOrganization', () => {
    ...
    it('should throw ConflictError for duplicate slug', async () => {
      ...
      mockDbOperations.organization.findUnique.mockResolvedValue(mockOrganization)
  ...
  describe('getOrganization', () => {
    it('should successfully get organization', async () => {
      ...
      mockDbOperations.organization.findUnique.mockResolvedValue(orgWithMembers)
    ...
    it('should throw NotFoundError for non-existent organization', async () => {
      ...
      // Act & Assert
      await expect(organizationService.getOrganization(
        'tenant-123',
        'user-123',
        'non-existent'
  ...
  describe('updateOrganization', () => {
    it('should successfully update organization', async () => {
      ...
      mockDbOperations.membership.findFirst.mockResolvedValue(membershipWithPermissions)
    ...
    it('should throw ForbiddenError for insufficient permissions', async () => {
      ...
      mockDbOperations.membership.findFirst.mockResolvedValue(membershipWithoutPermissions)
    ...
    it('should throw ConflictError for duplicate slug update', async () => {
      ...
      mockDbOperations.membership.findFirst.mockResolvedValue(mockMembership)
      mockDbOperations.organization.findFirst.mockResolvedValue(mockOrganization)
  ...
  describe('deleteOrganization', () => {
    ...
    it('should throw ForbiddenError for non-owner', async () => {
      ...
      mockDbOperations.membership.findFirst.mockResolvedValue(nonOwnerMembership)

      // Act & Assert
      await expect(organizationService.deleteOrganization(
        'tenant-123',
        'user-123',
        'org-123'
      )).rejects.toThrow(ForbiddenError)
  ...
  describe('updateMemberRole', () => {
    ...
    it('should throw ForbiddenError when trying to change owner role', async () => {
      ...
      // Act & Assert
      await expect(organizationService.updateMemberRole(
        'tenant-123',
        'user-123',
        'org-123',
  ...
  describe('removeMember', () => {
    ...
    it('should throw ForbiddenError when trying to remove owner', async () => {
      ...
      // Act & Assert
      await expect(organizationService.removeMember(
        'tenant-123',
        'user-123',
        'org-123',
        'owner-membership-123'
