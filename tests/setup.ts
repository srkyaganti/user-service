...
export const createTestTenant = (
	slug?: string,
	type?: "B2B" | "B2C" | "HYBRID",
) => testDbManager.createTestTenant(slug, type);
export const createTestUser = (tenantId: string, overrides?: any) =>
	testDbManager.createTestUser(tenantId, overrides);
export const createTestOrganization = (tenantId: string, overrides?: any) =>
	testDbManager.createTestOrganization(tenantId, overrides);
