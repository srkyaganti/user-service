...
app.openapi(updateProfileRoute, async (c) => {
	...
	const updatedUser = await userService.updateProfile(user.id, tenantId, body);
...
app.openapi(uploadAvatarRoute, async (c) => {
	...
	const updatedUser = await userService.uploadAvatar(user.id, tenantId, file);
...
app.openapi(searchUsersRoute, async (c) => {
	...
	const result = await userService.searchUsers(query.q, tenantId, {
		limit: query.limit,
		offset: query.offset,
